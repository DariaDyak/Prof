    ...
    <section className="pt-16 pb-4 sm:pb-0">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 lg:mb-12">
          <h2 className="text-xl sm:text-2xl dark:text-beige lg:text-3xl xl:text-3xl font-bold text-brown-dark mb-6 sm:mb-5 lg:mb-6">
            Результат <span>нашего сотрудничества</span>
          </h2>
          <div className="items-center">
            <div>
              <p className="text-brown-dark dark:text-beige text-justify leading-relaxed text-sm sm:text-base mb-6 sm:mb-8">
              ...
              <div className="mt-8 pt-6 border-t sm:pb-0">
                <p className="text-sm dark:text-beige sm:text-base text-center text-brown-dark italic">
