      ...
      <div className="container mx-auto px-4 lg:px-8 ">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {solutions.map((solution, index) => (
            <Card 
              key={index} 
              className="group bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-slate-200 dark:hover:shadow-none dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 shadow-lg hover:border-blue-300 dark:hover:border-blue-600 shadow-lg hover:shadow-2xl transition-all duration-300"
            >
              <CardContent className="p-4 sm:p-6 relative z-10 flex flex-col h-full">
                <div className="flex-1">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl lg:rounded-2xl bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white mb-3 sm:mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    {solution.icon}
                  </div>
