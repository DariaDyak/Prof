      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8 mt-10 sm:mb-10 lg:mb-12">
          <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-3xl font-bold text-foreground mb-4 sm:mb-5 lg:mb-6">
            Стратегическое <span className="text-blue-600 dark:text-blue-400">преимущество</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16 items-end items-stretch">
          ...
          <div className={`transition-all duration-700 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}>
            <div className="space-y-4 sm:space-y-6">
              <div className="group relative bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 transition-all duration-300 shadow-lg overflow-hidden flex-1">
                {/* Эффект градиентной границы при наведении */}
                <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 duration-500 -z-10">
                ...
                {metrics.map((metric, index) => (
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
                      {/* Иконка слева */}
                      <div className="flex-shrink-0">
                        <metric.icon className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-blue-600 transition-transform duration-300" />
                      </div>
            ...
            <div className="flex flex-col h-full">
              <div className="space-y-4 sm:space-y-6 flex-1 h-full">
                {features.map((feature, index) => (
                  <div
                    key={feature.title}
                    className="group bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200 dark:border-slate-700 dark:hover:shadow-none hover:border-blue-300 dark:hover:border-blue-600 shadow-lg hover:shadow-2xl transition-all duration-300 h-[calc(24%-13px)] sm:min-h-[60px]"
                  >
              ...
              ">
                      ...
                      <div className="flex-1">
                        <h3 className="text-base sm:text-lg lg:text-xl font-bold text-foreground group-hover:text-blue-600 transition-colors duration-300 leading-tight mb-2">
                          {feature.title}
                        </h3>
        ...
        <div className={`w-full transition-all duration-700 delay-500 mb-16 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
          <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 rounded-3xl p-8 lg:p-12 text-center overflow-hidden shadow-2xl">
