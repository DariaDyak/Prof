  ...
  return (
    <section id="about" className="pt-20 pb-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-start"> {/* Изменил на items-start */}
          ...
          <div className="lg:order-last">
            <Card className="overflow-hidden border-0 shadow-lg h-[425px]"> {/* Такая же фиксированная высота */}
