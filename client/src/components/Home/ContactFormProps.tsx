...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!trimmedFormData.name || !trimmedFormData.email || !trimmedFormData.message || !isPolicyAccepted) {
      setSubmitStatus("error");
      setSubmitMessage("Заполните обязательные поля и подтвердите согласие на обработку персональных данных.");
      return;
    }
    ...
    try {
      await submitContactRequest({
        ...trimmedFormData,
        consentAccepted: isPolicyAccepted,
  ...
  return (
    <section id="contactform" className="py-10 bg-beige/20 dark:bg-beige">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    disabled={isLoading}
                    className="!text-brown-dark text-sm md:text-base rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-beige/20 transition-all duration-300 resize-none placeholder:text-brown/50"
/>
                </div>
              ...
              <div className="flex items-center space-x-3 pt-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    setIsPolicyAccepted(checked as boolean);
                    if (submitStatus !== "idle") {
                      setSubmitStatus("idle");
                      setSubmitMessage("");
                    }
