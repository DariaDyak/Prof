...
import { Database, FileText, Shield, X, Zap, Cpu, Train, ArrowRight, Calculator } from 'lucide-react';
    ...
    const products = [
        {
            ...
            certificate_image: '/assets/images/certificate_1.png'
        },
        {
            id: 2,
            ...
            certificate_image: '/assets/images/certificate_2.png'
        },
        {
            id: 3,
            title: 'Система ПРОФИТ-УМО',
            short_description: 'Расширение для 1С:Бухгалетрии для автоматизации учета медицинских осмотров',
            platform: '1С:Предприятие 8.3',
            registration_num: '2025688393',
            reg_program_num: null,
            certificate_image: '/assets/images/certificate_3.png'
        }
    ];
    ...
    return (
        <section id="cases" className="py-12 sm:py-12 bg-beige/50 overflow-hidden">
            <div className="container mx-auto h-full px-4 lg:px-8">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-10 sm:mb-14 lg:mb-16">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-brown text-sm mt-6 sm:mt-3 lg:mt-8 sm:text-lg dark:text-beige mb-3 max-w-3xl">
                            Мы сотрудничаем с компаниями из разных секторов экономики, предлагая индивидуальные решения    </p>
                    </div>

                    <a
                        href="/ProjectsPage"
                        className="group relative inline-flex items-center gap-2 font-semibold transition-all duration-300
