  ...
  <div className="container mx-auto px-4 lg:px-8">
    ...
    <div className="mb-6 sm:mb-8">
      <div className="flex flex-wrap gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm bg-white border dark:border">
        ...
        <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm bg-white border border-beige/30 dark:border-beige/30">
    ...
    <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
      <div className="p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl border border-beige/30 dark:border-beige/30">
    ...
    <div className="mb-6 sm:mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
        <div className="p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl lg:rounded-2xl border border-beige/30 shadow-lg transition-all duration-300 overflow-hidden flex flex-col">
          ...
          <p className="text-xs sm:text-sm text-brown-dark text-justify">Полная автоматизация процессов купли-продажи электроэнергии</p>
        </div>
        ...
        <div className="p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl lg:rounded-2xl border border-beige/30 shadow-lg transition-all duration-300 overflow-hidden flex flex-col">
          ...
          <p className="text-xs sm:text-sm text-brown-dark text-justify">Снижение рисков и повышение эффективности</p>
        </div>
        ...
        <div className="space-y-2 sm:space-y-3">
          {productInfo.documentation.map((doc, index) => (
            <button
              ...
              className="w-full text-left p-3 sm:p-4 bg-white rounded-lg lg:rounded-2xl border border-beige/30 shadow-lg transition-all duration-300 group/doc flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed hover:border-brown-dark"
            >
